                ...
                <tbody>
                    ...
                    while ($rows = mysqli_fetch_assoc($result)) {
                        echo "
                            ...
                            <td class = 'data'><a href='Admin_users_update.php?usersId=$rows[usersId]'  class='btn1'>Edit</a></td>
                            <td class = 'data'><a href='Admin_users_function.php?usersId=$rows[usersId]'  class='btn2'>Delete</a></td>
                            </tr>
                        ";
                    }
                    ?>
