...
<body>
    ...
    <div class="form-container">
        <form action="Admin_upcoming_movie_function.php" method="post" enctype="multipart/form-data">
    ...
    <div class= "bottom-data">
        <div>
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="Admin_movie_upcoming.php" id="upcoming">Upcoming Movie</a>
                </li>

                <li class ="icons">|</li>

                <li class="nav-item">
                <a class="nav-link" href="Admin_movie_slider.php" id="movie-slider">Movie Slider</a>
                </li>
            </ul>
            ...
            <table>
                ...
                <tbody>
                    <!-- Movie display -->
                    <?php
                    $sqlimage  = "SELECT * FROM upcoming_movie";
                    ...
                    while ($rows = mysqli_fetch_array($imageresult1)) {
                        echo "
                            ...
                            <td class='data'>" . $rows['duration'] . "</td>
                            <td class='data'>" . $rows['category'] . "</td>
                            <td class='data'>" . $rows['description'] . "</td>
                            <td class = 'data'><img src = 'Image/{$rows['image']}' width = '150px' height = '150px'/></td>
                            <td class = 'data'><a href='Admin_movie_upcoming_update.php?id=$rows[id]'  class='btn1'>Edit</a></td>
                            <td class = 'data'><a href='Admin_upcoming_movie_function.php?id=$rows[id]'  class='btn2'>Delete</a></td>
                            </tr>
                        ";
                    }
                    ?>
