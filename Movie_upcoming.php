...
<body>
    ...
    <section class="main-container">
        ...
        <div class="option-1 line"><a href="Movie_now_showing.php">Now Showing</a></div>
        <div class="option-2 line"><a href="Movie_upcoming.php" class='home-active'>Upcoming</a></div>
        <div></div>
        <div></div>
        <div></div>
            ...
            echo "<div class='movie-card'>
                ...
                <div class='movie-details'>
                    <div class='part-1'>
                        ...
                        <span><i class='fa-solid fa-bookmark'></i> ".$row['category']."</span>
                        <span><i class='fa-solid fa-clock'></i> ".$row['duration']." min</span>
                        <span><i class='fa-solid fa-language'></i> ENG</span>
                        <span><i class='fa-solid fa-closed-captioning'></i> ENG</span>
                    </div>
                    <div class='part-2'>
                        <div class='movie-card-btn'><a href='movie_description.php?type=upcoming&movie=".$row['name']."' 
                        class='view-more'>View More</a></div>
                    </div>
                </div>
            </div>";
        }
