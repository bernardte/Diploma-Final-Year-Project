...
<body>
  ...
  if (isset($_GET['id'])) {
      ...
      $id = $_GET['id'];
      $sql = "SELECT * FROM movie_slider WHERE id = '$id'";
  ...
  if (isset($_POST['update'])) {
      ...
      $sql = "UPDATE movie_slider SET name = '$name', image = '$image' WHERE id = '$id'";
      $result = mysqli_query($conn, $sql);
  ...
  <form action="Admin_movie_slider_update.php" method="post" enctype="multipart/form-data">
    <table>
    <th>Edit Movie Slider</th>
