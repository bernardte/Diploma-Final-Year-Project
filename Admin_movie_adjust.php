    ...
    <div class= "bottom-data">
        <div>
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="Admin_movie_adjust.php" id="now-showing">Now Showing Movie</a>
                </li>
            ...
            <table>
                ...
                <tbody>
                    <!-- Movie display -->
                    <?php
                    $sqlimage  = "SELECT * FROM now_showing_movie";
                    ...
                    while ($rows = mysqli_fetch_array($imageresult1)) {
                        echo "
                            ...
                            <td class = 'data'><a href='Admin_movie_update.php?id=$rows[id]'  class='btn1'>Edit</a></td>
                            <td class = 'data'><a href='Admin_movie_function.php?id=$rows[id]'  class='btn2'>Delete</a></td>
                            </tr>
                        ";
                    }
                    ?>
