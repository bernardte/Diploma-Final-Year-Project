...
<head>
    ...
    <link rel="stylesheet" href="CSS/Admin_food_adjust.css" />
...
<body>
    ...
    <div class="form-container">
        <!-- Upload movie -->
        <form action="Admin_food_function.php" method="post" enctype="multipart/form-data">
            <label for="foodName">Name: </label>
            <input type="text" name="foodName" id="foodName" required value="" placeholder="Food Name..."><br />
            <label for="quantity">Quantity: </label>
            <input type="text" name="quantity" id="quantity" required value="" placeholder="Quantity..."><br />
            <label for="price">Price: </label>
            <input type="text" name="price" id="price" required value="" placeholder="Price..."><br />
        ...
        <div>
            ...
            <table>
                ...
                <tbody>
                    <!-- Movie display -->
                    <?php
                    $sqlimage  = "SELECT * FROM food";
                    $imageresult1 = mysqli_query($conn, $sqlimage);
                    while ($rows = mysqli_fetch_assoc($imageresult1)) {
                        echo "
                            <tr class='row'>
                            <td class='data'>" . $rows['id'] . "</td>
                            <td class='data'>" . $rows['foodName'] . "</td>
                            <td class='data'>" . $rows['price'] . "</td>
                            <td class='data'>" . $rows['quantity'] . "</td>
                            <td class = 'data'><img src = 'Image/{$rows['image']}' width = '150px' height = '150px'/></td>
                            <td class = 'data'><a href='Admin_food_update.php?id=$rows[id]'  class='btn1'>Edit</a></td>
                            <td class = 'data'><a href='Admin_food_function.php?id=$rows[id]'  class='btn2'>Delete</a></td>
                            </tr>
                        ";
                    }
                    ?>
