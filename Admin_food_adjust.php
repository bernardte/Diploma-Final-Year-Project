                ...
                <tbody>
                    ...
                    while ($rows = mysqli_fetch_assoc($imageresult1)) {
                        echo "
                            ...
                            <td class = 'data'><a href='Admin_food_update.php?id=$rows[id]'  class='btn'>Update</a></td>
                            <td class = 'data'><a href='Admin_food_function.php?id=$rows[id]'  class='btn'>Delete</a></td>
                            </tr>
                        ";
                    }
                    ?>
