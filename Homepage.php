...
<body>
    ...
    <section class="home swiper" id="home">
            ...
            <div class="swiper-wrapper">
                <?php
                $sql = "SELECT * FROM movie_slider";
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<div class='swiper-slide container'>
                        <img src='Image/".$row['image']."' alt='".$row['image']."' class='image-slider'>
                        <div class='home-text'>
                            <h1>".$row['name']."</h1>";
                            if (isset($_SESSION["useruid"])) {
                                echo "<a href='booking_index_page.php?movie=".$row['name']."' class='btn'>Book Now</a> ";
    ...
    <section class="comming" id="comming">
        ...
        <div class="movie-container-2">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                echo "<div class='box'>
                    <a href='movie_description.php?type=upcoming&movie=".$row['name']."'>
                        <div class='box-img'>
