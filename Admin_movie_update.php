...
// update to the database by selecting the the movie id
    $sql = "UPDATE movie SET name = '$name', image = '$image' WHERE id = '$id'";
    $result = mysqli_query($conn, $sql);
...
<form action="Admin_movie_update.php" method="post" enctype="multipart/form-data">
  <table>
  <th>Movie Update</th>
    <tr>
      <td class="container">
        <label class="label-adjust" for="name">Name:</label class="label-adjust">
