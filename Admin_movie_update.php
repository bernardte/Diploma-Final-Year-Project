...
if (isset($_GET['id'])) {
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM now_showing_movie WHERE id = '$id'";
    $result = mysqli_query($conn, $sql);
    $data = mysqli_fetch_assoc($result);
}

// Check if the user pressed the update button and implement POST method
if (isset($_POST['update'])) {
    ...
    // Update the database by selecting the movie id
    $sql = "UPDATE now_showing_movie SET name = '$name', duration = '$duration', category = '$category',
...
<form action="Admin_movie_update.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
    <table>
        <th>Edit Now Showing Movie</th>
        ...
        <tr>
            <td class="container">
                <label class="label-adjust" for="description">Description:</label class="label-adjust">
