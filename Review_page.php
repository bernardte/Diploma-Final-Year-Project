...
<body>
    ...
    <section class="rate-and-review">
        <div class="rate-and-review-container">
            <div class="head"><h1><?php echo $_GET["movie"] ?></h1></div>
            <div class="rate-and-review-text"> <p>We are glad to listen your review</p></div>
            ...
            <div class="footer-width-link">
                ...
                <div class="navbar">
                    <ul>
                        ...
                        <li><a href="Movie_now_showing.html">Movie</a></li>
